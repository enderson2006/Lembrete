      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
            <div>
              <h4 className="font-medium text-gray-900">Ativar envio por e-mail</h4>
              <p className="text-sm text-gray-600">Receba lembretes por e-mail quando programados</p>
            </div>
            ...
            <>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-3 py-2 pr-10 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                      errors.senderPassword ? 'border-red-500' : 'border-gray-300'
                    }`}
                ...
                {errors.senderPassword && (
                  <p className="mt-1 text-sm text-red-600">{errors.senderPassword}</p>
                )}
